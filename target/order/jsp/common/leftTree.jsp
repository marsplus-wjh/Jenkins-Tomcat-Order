...
<ul class="nav nav-list">
    ...
    <li <%if ("adControl".equalsIgnoreCase(_currentMenuOpen)) {%> class="active open" <%}%>>
        <a href="#" class="dropdown-toggle">
            <i class="icon-desktop"></i> <span class="menu-text"> Management </span>
        ...
        <ul class="submenu">
            <li <%if ("addMenu".equalsIgnoreCase(_currentMenu)) {%> class='active'  <%}%>>
                <a href="/addMenu">
                    <i class="icon-double-angle-right"></i>Add Cuisine
                </a>
            </li>
            <li <%if ("cateList".equalsIgnoreCase(_currentMenu)) {%> class='active'  <%}%>>
                <a href="/showCategories">
                    <i class="icon-double-angle-right"></i>Categories
                </a>
            </li>
            <li>
                <a href="/addCategory">
                    <i class="icon-double-angle-right"></i>Add Category
                </a>
            </li>
        </ul>
    </li>
